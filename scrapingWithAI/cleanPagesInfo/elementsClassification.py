...
from collections import defaultdict             # loads the data from the json, that comes from the playwright elements
from urllib.parse import urlparse               # url parsing
import re

with open('../extractPagesInfo/resultsElements/elementsToClassify.json', 'r') as f:
    data = json.load(f)
"""
But, on elements, i already have all the info that i need, like Title, Price, Cuotas, Stocked, and nothing more else (NO link, NO image)
"""
# elements & tag is no longer being used for this version
...
with open('response/classified/classifiedElements.json', 'w', encoding='utf-8') as f:
